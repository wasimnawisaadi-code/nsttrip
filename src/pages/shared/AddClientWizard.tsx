  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await supabase.from('client_services').insert({
        ...
        documents: form.documents as any,
        status: 'Success' as const, request_month: selectedMonth, created_by: user.id,
      });
          ...
          <div className="space-y-6">
            ...
            <div className="border-t border-border pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {form.service === 'UAE Visa' && <UAEVisaFields sub={form.serviceSubcategory} form={form} updateSD={updateSD} Field={Field} SelectField={SelectField} />}
